...
///get user as instructor data///
$select = "SELECT * FROM `users` WHERE types='instructor' ";
$allusers=mysqli_query($connect,$select);

///get instructors data///
$select = "SELECT * FROM `instructors` ";
$allstudents=mysqli_query($connect,$select);
$count=1;
?>
<body>
<?php 
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">List Instructors <a class="float-end" href="./create.php">Create New Instructor</a></h5>
