...
auth(2,3);
///get user as student data///
$select = "SELECT * FROM `users` WHERE types='student' ";
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">List Students <a class="float-end" href="./create.php">Create New Student</a></h5>
